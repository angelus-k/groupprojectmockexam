...
@Component
public class DataQuestionsBA10 implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		typeOfExam.setDuration(600);
		typeOfExam.setNumberOfQuestions(10);
		typeOfExam.setExamType("10 Questions BAExam");
		...
		q13.setQuestionText("Which of the following BEST describes anethnographic study?");
		Answer a13 = new Answer("A study which uses prototype graphical screens to demonstrate a user requirement", 0);
		Answer b13 = new Answer("A study of users in their workplace undertaking representative simulated scenarios",
				0);
		Answer c13 = new Answer("A study where the analyst spends an extended period of time in the target environment",
				1);
		Answer d13 = new Answer("A study which ensures that the needs of a whole range of ethnic groups are considered",
				0);
		...
		q14.setQuestionText(
				"In the Boston Box, what is the name given to products with low market growth and high market share?");
		...
		q15.setQuestionText(
				"The Consider Perspectives stage of the Business Analysis Process Model is primarily concerned with analysing which of the following?");
		...
		Answer a18 = new Answer(
				"Allows business users to clarify, elaborate and prioritise the requirements during the development process",
				0);
		...
		q19.setQuestionText(
				"The Holistic Approach to Business Analysis includes 4 areas to consider. 3 of them are People, Processes and Organisation. The 4th one is");
		...
		q31.setQuestionText(
				"One of the characteristics of the functional view of the organisation is the tendency employees to maximise the performance of their own business unit without regard to other business units in the organisation. What is characteristic called?");
		...
		Answer c33 = new Answer(
				"Compare the competencies held by an individual and those required for a particular role", 0);
		Answer d33 = new Answer(
				"Compare the IT system requirements and the features offered by an off-the-shelf software package", 0);
		...
		q35.setQuestionText(
				"Business rules define how actions are to be performed. Under which of the following headings are business rules considered?");
		...
		Answer a39 = new Answer(
				"A value stream is used to identify, map and analyse the value exchanged between an organisation and various stakeholders (internal and external) that interact with it",
				0);
		Answer b39 = new Answer("A value stream shows the main sequential stages which add value to the customer", 0);
		Answer c39 = new Answer(
				...
				0);
		Answer d39 = new Answer(
				"A value stream Customer is the end-customer for which value is recognised, but not an internal customer",
				1);
		...
		q41.setQuestionText(
				"An analyst has discovered that a company wishes to hold information about departments and employees. A department may have many employees in it, but each employee can, at one time, only work in one department. There is no requirement to store historical information. However, there are currently eight departments and over one hundred employees. How would this relationship be shown on an Entity Relationship diagram?");
		...
		q43.setQuestionText(
				"The following is a typical example of how a User Story is stated:'As an Account Manager, I want to be able to record the details of a call received from a Client, so that I can accurately complete contract details when I place a Consultant.'In this statement, what is the purpose of stating 'so that I can'?");
		...
		q48.setQuestionText(
				"A system holds information about an employee, Mike Berry. Which of the following is Mike Berry and example of?");
		...
		q67.setQuestionText(
				"A batch program runs every night to raise invoices. The next day these invoices are posted out to customers by a clerk. Customers pay the invoices with cheques. The cheques are then banked by a clerk. In this scenario, which of the following represents a business event?");
		...
		Answer b71 = new Answer("It is preferable for the calculated IRR of a project to be below bank interest rates.",
				0);
		...
		Answer a74 = new Answer(
				"It has meant that it is no longer necessary for analysts to define rigorous, accurate and complete user requirements.",
				0);
		Answer b74 = new Answer(
				"It has eliminated the need for effective contract management between the customer and the supplier of the outsourcing.",
				0);
		Answer c74 = new Answer(
				"It has been a significant catalyst in organisation for the development of a business analysis function.",
				1);
		Answer d74 = new Answer(
				"It has meant that the programming of solutions is usually undertaken in countries where labour costs are high.",
				0);
		...
		q88.setQuestionText(
				"A software house is developing a software package specifically for hotel management. A business analyst has been employed because of her familiarity with the hotel industry. Which of the following competencies has she been employed to bring to the project?");
		...
		q92.setQuestionText(
				"Which of the following stages is immediately after problem-finding in Isaksen and Treffingerâ€™s creative problem-solving model?");
		...
		Answer d98 = new Answer(
				"Social and cultural factors have little influence on the success of implementing changes.", 0);
		...
		q107.setQuestionText(
				"One of the claimed advantages of buying a softwar package is that it is possible to predict future maintenance costs with some certainty. How would these costs be classified in acost-benefit analysis?");
		...
		q112.setQuestionText(
				"In which of the following categories would return on investment be considered when assessing the feasibility of aproject?");
		...
		q115.setQuestionText(
				"During a workshop, it is useful to ask participantsto come up with ideas which are listed for later evaluation. What isthis technique called?");
		...
		Answer c120 = new Answer("The computer system would be the boundary, the project reporting system a use case.",
				0);
		...
		q122.setQuestionText(
				"Which of the following is NOT one of the perspectives considered by the 'Balanced Business Scorecard'?");
		...
		q124.setQuestionText(
				"A project reporting system stores information about Employees. How would an Employee be represented in an entity-relationship diagram?");
		...
		Answer a133 = new Answer("Design", 1);
		Answer b133 = new Answer("Development", 0);
		...
		Answer a137 = new Answer("The person who documented the risk in therisk register.", 0);
		...
		Answer d137 = new Answer("The person best placed to take the necessary", 1);
		q137.setNumberOfCorrectAnswers(1);
		List<Answer> ansList137 = Arrays.asList(a137, b137, c137, d137);
		...
		q138.setQuestionText(
				"One of Porterâ€™s five forces explicitly considers industry competitors. Which of the following is the Key Focusâ€™ of this force?");
		...
		q139.setQuestionText(
				"Which ONE model is used for planning the training of the support that people need as they adapt to change?");
		...
		q141.setQuestionText(
				"A requirement has been identified as beneficial. It will be included in the system if it does not take too long to deliver or costs too much. How would this requirement be prioritised in the MOSCOW classification?");
		...
		q142.setQuestionText(
				"It is claimed that a new system will bring improved job satisfaction to employees. How should this improved job satisfaction be classified?");
		...
		q144.setQuestionText(
				"When undertaking business system modelling how many Business Activity Modelsâ€™ (BAMâ€™s) are initially produced?");
		...
		Answer a147 = new Answer(
				"Improving the business process is concerned with removing problems identified in the AS-IS process.",
				1);
		...
		q149.setQuestionText(
				"An airline wishes to assess the punctuality of its flights. What type of business activity would do this?");
		...
		Answer d150 = new Answer("When the users have had the opportunity to use the software for a period of time.",
				0);
		...
		q157.setQuestionText(
				"What are business case development, subject matter expertise and procurement all examples of?");
		...
		q165.setQuestionText(
				"What are subsequent changes subject to once a requirements document has been signed off?");
		...
		Answer b170 = new Answer("Rich pictures and mind maps are used to document the requirements for the IT system.",
				0);
		Answer c170 = new Answer(
				"Interviews are effective in building a consensus view and securing agreement from a diverse group.",
				0);
		Answer d170 = new Answer(
				"Ethnographic Studies are concerned with the long term observation of the business environment.", 1);
		...
		q179.setQuestionText(
				"A business analyst wishes to show that a company wants to store information about different types of product. Some attributes are common to every product (for example: product name) but other attributes only apply to certain product types. Forexample, product material only applies to accessory products. Whichof the following constructs could the business analyst use to represent this on a class model?");
		...
		q184.setQuestionText(
				"An IT department needs to upgrade its hardware to run the new version of an established operating system. The cost of this required upgrade is $2 million. As an alternative, the IT director has suggested that the company should change to a completely different operating system. Although this will cost $6 million, thechange will bring many other benefits, including cheaper maintenance costs and increased security. What is the avoided cost in his proposal?");
		...
		q185.setQuestionText(
				"Which of the following are steps in the Isaksen and Treffinger's creative problem solving model? <br> a. Mess Finding<br> b. Data Modelling <br> c. Process Finding <br> d. Problem Finding <br> e. Solution Finding");
		...
		q186.setQuestionText(
				"Business Analysis competencies are divided into three groups. Which of the following are the groups of competencies for a Business Analyst? <br> a. IT skills <br> b. BehaviouralManagement Support <br> c. Techniques <br> d. Project ManagementSupport <br> e. Business knowledge ");
		...
		q192.setQuestionText(
				"The entity relationship model below shows the relationship between Product and Order. Which of the following business rules is correct and is reflected in the diagram? <br> <img src=\"../../assets/bildquestion89.png\" />");
		...
		q193.setQuestionText(
				"The entity relationship model below shows the relationship between Customer and Order. Which of the following business rules is correct? <br> <imgsrc=\"../../assets/bildquestion157.PNG\" />");
		...
		q194.setQuestionText(
				"Which of the following is not normally considered to be within the range of a Business Analysts responsibilities?");
		...
		q196.setQuestionText(
				"Which of the following is considered an advantage of employing an internal Business Analyst consultant?");
		...
		q198.setQuestionText(
				"Which of the following is NOT considered a valued way of working in Agile practice, as stated in the Agile Manifesto?");
		...
		q199.setQuestionText(
				"Which of the following are normally regarded as the four key views of a business system?");
		...
		q200.setQuestionText(
				"Businesses are motivated by different targets at different levels within the organisation. Which of the following best represents a sequential description of these motivations?");
		...
		q201.setQuestionText(
				"Within a Balanced Business Scorecard, what technique would be most suitable for Vision and Strategy?");
		...
		Answer c202 = new Answer("Human", 1);
		...
		q203.setQuestionText(
				"Within a Boston Box, if a product has low market growth and high market share, it is said to be a:");
		...
		q207.setQuestionText(
				"In addition to the six key stages of the Business Analysis Process Model, there is also a stage which runs in parallel throughout these. This stage is called?");
		...
		q215.setQuestionText(
				"If you wish to build a good relationship with stakeholders and extract detailed information, which of the following investigation techniques should you use?");
		...
		q217.setQuestionText(
				"Which of the following are suitable analysis techniques for use with Agile requirements?");
		...
		q218.setQuestionText(
				"Which of the following best describes when the stakeholders will hold the positions on a power/interest grid?");
		...
		q219.setQuestionText(
				"Which type of stakeholder will work actively to impede the project because they do not agree with its objectives?");
		...
		q220.setQuestionText(
				"On the power/interest grid, how should one deal with stakeholders with high power, and medium interest?");
		...
		q223.setQuestionText(
				"Which of the following do business perspectives/root definitions (CATWOE) and business activity models (BAM) show?");
		...
		q232.setQuestionText(
				"The key structural elements of a Business Architecture represent which one of the following sets?");
		Answer a232 = new Answer("business motivations, business capabilities, value chains, information concepts", 0);
		Answer b232 = new Answer("business processes, business capabilities, value propositions, information concepts",
				0);
		...
		q233.setQuestionText(
				"Which of the following techniques is suitable for modelling Business Architecture <b>in detail</b>?");
		...
		q235.setQuestionText(
				"Which of the following techniques would be suitable for use in a Gap Analysis from the Organisation view of the POPIT model? ");
		...
		q237.setQuestionText(
				"Which of the following options should always be considered when developing a business case for a new system?");
		...
		q239.setQuestionText(
				"What are the three main aspects of feasibility to be considered when evaluating a business case?");
		...
		q240.setQuestionText(
				"At which stage of the Requirements Engineering process do we scrutinise requirements to ensure they are well formed?");
		...
		q241.setQuestionText(
				"When using an Agile approach to develop a software product, which of the following is NOT a suitable technique for capturing/specifying requirements?");
		...
		q243.setQuestionText(
				"Within Requirements Engineering, which stakeholder group would have the role of advising on industry best practise?");
		...
		q245.setQuestionText(
				"Which of the following describes a valid reason for using a modified requirements gathering process in Agile software development?");
		Answer a245 = new Answer("‘Scope creep’ may occur if developers miss the bigger picture (Business Objectives).",
				0);
		...
		q246.setQuestionText(
				"Of the following sets of requirements which one contains only non-functional requirements?");
		...
		q248.setQuestionText(
				"A requirement has been identified to restrict the level of access to personal data. Which type of requirement is this?");
		...
		q249.setQuestionText(
				"When prioritising functionality, if a feature is deemed to be mandatory at some point in the future it is a < what > requirement?");
		...
		q251.setQuestionText(
				"If we need to find out more information about why a requirement was requested, which element of requirements management allows us to trace this?");
		...
		q256.setQuestionText(
				"When we consider the delivery of the requirements, what phase is concerned with the methods and standards?");
		...
		q257.setQuestionText(
				"In the Generic Agile Model, which stage do we start the software development process with?");
		...
		q260.setQuestionText(
				"In the Design stage of the Business Change Lifecycle, which of the following techniques is used in the design and performance of User Acceptance Tests (UAT)?");
		...
		q262.setQuestionText(
				"Which phase of the Business Change Lifecycle is concerned with gaining user acceptance and buy in of the new system?");
		...
		q263.setQuestionText(
				"The Alignment stage of the Business Change Lifecycle is concerned with our strategy implementation. Which tool could we use to ensure strategy alignment?");
