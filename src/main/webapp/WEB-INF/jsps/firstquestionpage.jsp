...
<title>First Question Page</title>
...
<body class="background no-scroll always">
	...
	<input type="text" name="reportText" value="null"
	...
	<div class="row">
		<form action="/nextquestion" method="post">
			...
			<div class="question-instructions">
				<input type="checkbox" name="radio" value="0" style="display: none;"
					checked="checked"> <input type="hidden"
					value="${Exam.geteId()}" name="eId"> <input type="hidden"
					value="${questionNumber}" name="questionNumber">
				...
				<c:forEach
					...
					<c:choose>
						<c:when
							test="${Exam.geteQuestions().get(questionNumber).getChosenAnswers().size() != 0}">
							<c:choose>
								<c:when
			...
			<div class="questionpage-button-container">
				<div class="row">
					<button type="submit"
						class="reviewboxbuttononreviewpage btn-question"
